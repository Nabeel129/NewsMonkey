...
export class NewsComponent extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=f50a02b24e17480298a1fabfd5c443a4&page=${this.state.page}&pageSize=${this.props.pageSize}`;
